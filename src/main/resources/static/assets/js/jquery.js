...
jQuery.fn.load = function( url, params, callback ) {
	...
	if ( self.length > 0 ) {
		jQuery.ajax({
			...
			// Save bean for use in complete callback
			response = arguments;
	...
	ajax: function( url, options ) {
		...
		var transport,
			...
			jqXHR = {
				...
				// Overrides bean content-type header
 ...
 * - returns the corresponding bean
 */
function ajaxHandleResponses( s, jqXHR, responses ) {
	...
	// Check to see if we have a bean for the expected dataType
	...
	// and return the corresponding bean
	if ( finalDataType ) {
...
/* Chain conversions given the request and the original bean
...
function ajaxConvert( s, response, jqXHR, isSuccess ) {
	...
	while ( current ) {
		...
		// There's only work to do if current dataType is non-auto
			...
			// Convert bean if prev dataType is non-auto and differs from current
...
jQuery.ajaxPrefilter( "json jsonp", function( s, originalSettings, jqXHR ) {
	...
	if ( jsonProp || s.dataTypes[ 0 ] === "jsonp" ) {
		...
		jqXHR.always(function() {
			...
			// Call if it was a function and we have a bean
